...
public class QuestionService {
    ...
    public ResponseEntity<String> addQuestion(Question question) {
        try {
            ...
            return new ResponseEntity<>("Operation executed successfully.", HttpStatus.CREATED);
        } catch (Exception e) {
            e.printStackTrace();
            return new ResponseEntity<>("The request encountered an issue.", HttpStatus.BAD_REQUEST);
        }
    }
